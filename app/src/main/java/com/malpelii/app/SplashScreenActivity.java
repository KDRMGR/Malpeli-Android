...
public class SplashScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Prevent flash of default splash screen
        ...
        // Set the custom MALPELI logo drawable
        MalpeliLogoDrawable malpeliLogo = new MalpeliLogoDrawable();
        splashImage.setImageDrawable(malpeliLogo);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // Use white status bar text for black background
