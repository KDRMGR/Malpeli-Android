...
public class Config {
    ...
    public static final String PURCHASECODE = "7141f84b-5be0-4ec3-927a-a1b3d2ff4275";
    ...
    public static final String CUSTOM_DEEPLINK_SCHEME = "malpeli";
    ...
    public static final double SCALE_SPLASH_IMAGE = 70;
